        ...
        <div className={styles.headerInner}>
          <div className={styles.logo}>
            ...
            <div>
              ...
              <span className={styles.logoTag}>Multi-Chain Scanner</span>
            </div>
          </div>
          ...
          <div className={styles.scanView}>
            ...
            <div className={styles.heroSection}>
              ...
              <h1 className={styles.heroTitle}>
                Find Your
                <br />
                <span className={styles.heroAccent}>Airdrop Eligibility</span>
              </h1>
              <p className={styles.heroSub}>
                Scan Ethereum, Base, Arbitrum, Optimism, zkSync & 6 more chains.
                Get your eligibility score, gas spent, and Sybil risk — in under 1 second.
              </p>
            </div>
              ...
              {isScanning && (
                <div className={styles.progressWrap}>
                  ...
                  <span className={styles.progressLabel}>
                    Scanning {Math.round(scanProgress * 10)}ms... {scanProgress}%
                  </span>
                </div>
              )}
            </div>
              ...
              <div className={styles.resultsSection}>
                <div className={styles.resultsGrid}>
                  ...
                  <div className={styles.statsPanel}>
                    ...
                    <div className={styles.statCard}>
                      <span className={styles.statLabel}>Total Gas Spent</span>
            ...
            {!latestResult && !isScanning && (
              <div className={styles.benchmarkSection}>
                <h2 className={styles.benchmarkTitle}>Performance Benchmarks</h2>
                <div className={styles.benchmarkTable}>
                  ...
                  {[
                    { name: 'DropHunter', time: '~0.8s', chains: '10 chains', free: '✅', highlight: true },
                    { name: 'DeBank', time: '~4.2s', chains: '8 chains', free: '✅' },
                    { name: 'LayerLayer', time: '~2.8s', chains: '6 chains', free: '⚠️' },
                    { name: 'Arkham', time: '~5.1s', chains: '5 chains', free: '⚠️' },
                    { name: 'Rabby', time: '~3.5s', chains: '6 chains', free: '✅' },
                  ].map(row => (
                    <div key={row.name} className={`${styles.benchmarkRow} ${row.highlight ? styles.benchmarkHighlight : ''}`}>
                      <span>{row.name} {row.highlight && <span className={styles.benchmarkTag}>ours</span>}</span>
          ...
          <div className={styles.historyPanel}>
            ...
            {results.map((r, i) => (
              <div key={r.address + i} className={styles.historyCard}>
                <div className={styles.historyCardHeader}>
                  ...
                  <span className={styles.historyScore} style={{ color: r.totalScore >= 60 ? 'var(--accent)' : r.totalScore >= 30 ? 'var(--amber)' : 'var(--red)' }}>
                    {r.totalScore}/100
                  </span>
                </div>
            ...
            {results.length === 0 && (
              <div className={styles.emptyState}>
                ...
                <p>No scans yet. Paste a wallet address to get started.</p>
              </div>
            )}
          </div>
        )}
